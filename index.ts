...
import {submitButton, showTasksButton, closeDrawerButton} from './src/importer.js';
import {showTasksButtonHandler, closeDrawerButtonHandler, submitButtonCreateHandler} from './src/events.js';
...
submitButton?.addEventListener("click",submitButtonCreateHandler);
 //()=> {
...
showTasksButton?.addEventListener("click", showTasksButtonHandler);
// ()=> {
